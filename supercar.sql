...
(774, 'f', 'felaniaina@admin.com', 'fee'),
(775, 'dedded', 'felaniaina@admin.com', 'de'),
(780, 'd', 'felaniaina@admin.com', 'd'),
(783, 'frfffg', 'vatsysitrakiniaina@gmail.com', 'ggr');
...
(49, 'ddd', 'dz', '4x4', '2000', 'dzdzdzdzddz', '344', '../Image/2023-10-25 - VoaharinandrianinaFe.jpg'),
(54, 'DZDD', 'DZ', 'DZD', 'DZD', 'DZDZ', 'DZD', '../Image/1200x630wa.png'),
(55, 'dd', 'dd', 'dd', 'ddd', 'dd', 'dd', '../Image/1200x630wa.png'),
(56, 'Mercedes', 'de', '4x4', '2025', 'Découvrez les événements automobiles 2023 proches de chez vous en quelques secondes. En utilisant le filtre ci-dessous trouvez une multitude d’événements, Bourse d’échange, journée circuit rassemblements, dans votre région ou même dans votre ville ! Si vous êtes organisateur, n’attendez plus faites-vous connaître auprès des passionnés automobiles.', '100 000€', '../Image/703e3aefd9500eff0f63294bc383ac2a.jpeg'),
(57, 'Mercedes', 'de', '4x4', '2025', 'Découvrez les événements automobiles 2023 proches de chez vous en quelques secondes. En utilisant le filtre ci-dessous trouvez une multitude d’événements, Bourse d’échange, journée circuit rassemblements, dans votre région ou même dans votre ville ! Si vous êtes organisateur, n’attendez plus faites-vous connaître auprès des passionnés automobiles.', '100 000€', '../Image/tree.jpg');
...
--
ALTER TABLE `contact`
  MODIFY `idcontact` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=784;
