...
<head>
    ...
    <!-- Custom Css -->
    <link rel="stylesheet" href="../Css/admin/demanded'essai.css">
            ...
            <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        ...
                        <td colspan="2">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="details" name="details"
                                    readonly><?php echo $details; ?></textarea><br><br>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" id="heure1" name="heure1" value="<?php echo $heure1; ?>"
                                    readonly><br><br>
                            </div>
                        </td>
                        <td>
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" id="heure2" name="heure2" value="<?php echo $heure2; ?>"
                                    readonly><br><br>
                            </div>
                        </td>
                    </tr>
                ...
                <div class="form-group">
                    ...
                    <select id="Status1" name="Status1">
                        <option value="En cours" <?php if ($Status1 === "En cours")
                            echo "selected"; ?>>En cours</option>
                        <option value="Confirmé" <?php if ($Status1 === "Confirmé")
                            echo "selected"; ?>>Confirmé</option>
                        <option value="Terminé" <?php if ($Status1 === "Terminé")
