                            ...
                            <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
                                ...
                                <?php for ($i = 1; $i <= 5; $i++) : ?>
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="image<?php echo $i; ?>" name="image<?php echo $i; ?>" accept=".jpg, .jpeg, .png" onchange="previewImage<?php echo $i; ?>(this);">
                                        <img class="carousel-image" src="<?php echo ${"image" . $i}; ?>" alt="Image Preview" width="100">
                                    </div>
                                <?php endfor; ?>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <textarea id="apdn" name="apdn" class="form-control" required><?php echo $apdn; ?></textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="apdn1">A propos de nous 2:</label>
                                            <textarea id="apdn1" name="apdn1" class="form-control" required><?php echo $apdn1; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <img class="carousel-image" src="<?php echo $image_apdn; ?>" alt="Image Preview" width="100">
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <img class="carousel-image" src="<?php echo $image_apdn1; ?>" alt="Image Preview" width="100">
                                        </div>
                                    </div>
                                </div>
