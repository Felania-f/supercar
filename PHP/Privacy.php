            ...
            <tr>
                <td>
                    ...
                    <p>Cette politique de confidentialité s'applique au site&nbsp;: <span
                            id="span_id_nom_du_site">SuperCar</span>. <br /><br /></p>
                    ...
                    <p><br />Cette politique de confidentialité complète les mentions légales et les Conditions
                        Générales d'Utilisation que les utilisateurs peuvent consulter à l'adresse ci-après&nbsp;:</p>
                    <p style="padding-left: 30px;"><span id="span_id_url_cgu">Supercar/Privacy.com</span></p>
                    <p style="text-align: center;"><span
                            style="font-weight: bold; font-size: 14.56px;"><br /></span><strong>ARTICLE 2&nbsp;:
                            PRINCIPES GÉNÉRAUX EN MATIÈRE DE COLLECTE ET DE TRAITEMENT DE DONNÉES</strong><br /><br />
                    </p>
                    ...
                    <ul>
                        <li>Conservation des données réduites dans le temps&nbsp;: les données sont conservées pour une
                    ...
                    <ul>
                        <li>Le traitement peut s'expliquer par une nécessité liée à l'exécution d'une mission d'intérêt
                            public ou qui relève de l'exercice de l'autorité publique&nbsp;;</li>
                    </ul>
                    <ul>
                    ...
                    <p style="text-align: center;"><br /><strong>ARTICLE 3&nbsp;: DONNÉES À CARACTÈRE PERSONNEL
                            COLLECTÉES ET TRAITÉES DANS LE CADRE DE LA NAVIGATION SUR LE SITE<br /><br /></strong></p>
                    <p style="padding-left: 30px;"><strong>A. </strong>DONNÉES COLLECTÉES ET TRAITÉES ET MODE DE
                        COLLECTE</p>
                    <p>Les données à caractère personnel collectées sur le site <span
                            id="span_id_nom_du_site_internet">SuperCar.com</span> sont les suivantes&nbsp;:</p>
                    <p style="padding-left: 30px;"><span
                            id="span_id_liste_donnees_collectees">Prenoms;<br />Nom;<br />Genre;<br />Adresses;<br />Civilité;<br />Email;<br />Numero
                            de telephone.</span></p>
                    <p>Ces données sont collectées lorsque l'utilisateur effectue l'une des opérations suivantes sur le
                        site&nbsp;:</p>
                    <p style="padding-left: 30px;"><span id="span_id_operations_collectes_donnees">- Lorsque
                            l'Utilisateur ce connecte;<br />- Lorsque l'Utilisateur utilise le formulaire
                            de<br />contact pour envoyer une demande.</span> </p>
                    ...
                    <p>Le responsable du traitement conservera dans ses systèmes informatiques du site et dans des
                        conditions raisonnables de sécurité l'ensemble des données collectées pour une durée de&nbsp;:
                        <span id="span_id_duree_conservation_donnees">- Données comptables&nbsp;: 10 ans;<br />-
                            Candidatures&nbsp;: 2 ans;<br />- Documents contractuels, commerciaux&nbsp;: 3 ans;<br />-
                            Cookie d'analyse des visites&nbsp;: 13 mois.</p>
                    <p>La collecte et le traitement des données répondent aux finalités suivantes&nbsp;:</p>
                    <p style="padding-left: 30px;"><span id="span_id_finalite_traitement_donnees">- Traitement des
                            demandes, expédition des<br />vehicules;<br />- Réponse aux demandes envoyées par le
                            biais<br />du formulaire de contact.</span></p>
                    <p>Les traitements de données effectués sont fondés sur les bases légales suivantes&nbsp;:</p>
                    <p style="padding-left: 30px;"><span id="span_id_bases_legales">- Exécution du contrat;<br />-
                            Consentement de l'utilisateur;<br />- Obligation légale.</span></p>
                    ...
                    <p style="padding-left: 30px;"><span id="span_id_transmission_donnees_tiers">Certaines données
                            collectées sont transférées au proprietaire des vehicules, lorsque l'utilisateur réalise une
                            demande par le biais de la plateforme de demande du site.</span> <br /><br /></p>
                    <p style="padding-left: 30px;"><strong>C. </strong>HÉBERGEMENT DES DONNÉES</p>
                    <p>Le site <span id="span_id_nom_du_site_internet">SuperCar.com</span> est hébergé par&nbsp;: <span
                            id="span_id_denomination_sociale_de_l_hebergeur">Supercar Ltd</span>, dont le siège est
                        situé à l'adresse ci-après&nbsp;:</p>
                    <p style="padding-left: 30px;"><span id="span_id_siege_social_de_l_hebergeur">MEF-MCCI Building,
                            Ebène CyberCity, Ebène, Quatre Bornes</span></p>
                    <p>L'hébergeur peut être contacté au numéro de téléphone suivant&nbsp;: <span
                            id="span_id_telephone_de_l_hebergeur">+230 58426274</span>. </p>
                    <p>Les données collectées et traitées par le site sont transférées vers le(s) pays suivant(s)&nbsp;:
                        <span id="span_id_pays_transfert_donnees">Ile Maurice</span>. Ce transfert de données à
                        caractère personnel en dehors de l'Union européenne se justifie par les raisons ci-après&nbsp;:
                    </p>
                    <p style="padding-left: 30px;"><span id="span_id_pourquoi_donnees_envoyees_hors_ue">Les données sont
                            hébergées a l'Ile Maurice car le siége social de la société s'y situe.</span> </p>
                    <p style="text-align: center;"><br /><strong>ARTICLE 4&nbsp;: RESPONSABLE DU TRAITEMENT DES DONNÉES
                        </strong><span style="text-align: start;"><strong>ET DÉLÉGUÉ À LA PROTECTION DES
                                DONNÉES</strong> </span></p>
                    ...
                    <p>Le responsable du traitement des données à caractère personnel est&nbsp;: <span
                            id="span_id_prenom_nom_responsable">Babatoundé Olatounji</span>. Il peut être contacté de la
                        manière suivante&nbsp;:</p>
                    <p style="padding-left: 30px;"><span id="span_id_methode_contact_rtd">Le responsable du traitement
                            des données<br />peut étre contacté par téléphone au<br />+230 5846 5874, de 8h a 19h, du
                            lundi au<br />vendredi.</span></p>
                    <p>Le responsable du traitement des données est chargé de déterminer les finalités et les moyens mis
                        au service du traitement des données à caractère personnel. <br /><br /></p>
                    <p style="padding-left: 30px;"><strong>B. </strong>OBLIGATIONS DU RESPONSABLE DU TRAITEMENT DES
                        DONNÉES</p>
                    ...
                    <p>Dans le cas où l'intégrité, la confidentialité ou la sécurité des données à caractère personnel
                        ...
                        par tout moyen. <br /><br /></p>
                    <p style="padding-left: 30px;"><strong>C. </strong>LE DÉLÉGUÉ À LA PROTECTION DES DONNÉES</p>
                    <p>Par ailleurs, l'utilisateur est informé qu'un Délégué à la Protection des Données a été
                        nommé&nbsp;: <span id="span_id_nom_delegue_protection_donnees">Jean Valjean, DPO</span>.</p>
                    <p>Le rôle du Délégué à la Protection des Données et de s'assurer la bonne mise en oeuvre des
                        dispositions nationales et supranationales relatives à la collecte et au traitement des données
                        à caractère personnel. Il est parfois appelé DPO (pour Data Protection Officer).</p>
                    <p>Le délégué à la protection des données peut être joint de la manière suivante&nbsp;:</p>
                    <p style="padding-left: 30px;"><span id="span_id_coordonnees_dpo">Par téléphone&nbsp;:<br />au +230
                            5842 6274,<br />du lundi au vendredi de 9h a 17h&nbsp;;<br />Par mail&nbsp;:
                            tuckmansing2004@gmail.com.</span><br /><br /></p>
                    <p style="text-align: center;"><strong>ARTICLE 5&nbsp;: DROITS DE L'UTILISATEUR
                        </strong><br /><br /></p>
                    ...
                    <p>Le responsable du traitement des données est tenu de répondre à l'utilisateur dans un délai de 30
                        (trente) jours maximum.<br /><br /></p>
                    <p style="padding-left: 30px;"><strong>A.</strong> PRÉSENTATION DES DROITS DE L'UTILISATEUR EN
                        MATIÈRE DE COLLECTE ET TRAITEMENT DE DONNÉES</p>
                    ...
                    <p style="padding-left: 30px;"><span id="span_id_procedure_acces_donnees">L'utilisateur doit envoyer
                            un e-mail au<br />responsable du traitement des données<br />personnelles, en précisant
                            l'objet de sa<br />demande, a l'adresse e-mail de contact.</span> </p>
                    ...
                    <p style="padding-left: 30px;"><span id="span_id_procedure_suppression_compte">L'utilisateur doit
                            envoyer un e-mail au<br />responsable du traitement en précisant son<br />numero d'espace
                            personnel. La demande sera<br />raitée dans un délai de 10 jours ouvrés.</span><br /><br />
                    </p>
                    ...
                    <p style="padding-left: 30px;"><span
                            id="span_id_procedure_portabilite_donnees_personnelles">L'utilisateur doit faire une demande
                            de<br />portabilité de ses données personnelles auprés<br />du responsable du traitement des
                            données, en<br />envoyant un e-mail a l'adresse prévue ci-dessus.</span></p>
                    ...
                    <p style="padding-left: 30px;"><span id="span_id_procedure_limitation_traitement">L'utilisateur doit
                            faire une demande de<br />limitation au traitement de ses données<br />personnelles par
                            e-mail aupres du responsable<br />du traitement des données.</span><br /><br /></p>
                    ...
                    <p>Dans le cas où le responsable du traitement des données décide de ne pas répondre à la demande de
                        ...
                        compétent. <br /><br /></p>
                    <p style="padding-left: 30px;"><span style="font-weight: bold; font-size: 14.56px;">B.
                        </span>DONNÉES PERSONNELLES DES PERSONNES MINEURES</p>
                    ...
                    <p>L'éditeur du site se réserve le droit de vérifier par tout moyen que l'utilisateur est âgé de
                        ...
                        site.<br /><br /></p>
                    <p style="text-align: center;"><strong>ARTICLE 6&nbsp;: CONDITIONS DE MODIFICATION DE LA POLITIQUE
                            DE CONFIDENTIALITÉ<br /><br /></strong></p>
                    <p>La présente politique de confidentialité peut être consultée à tout moment à l'adresse ci-après
                        indiquée&nbsp;:</p>
                    <p style="padding-left: 30px;"><span
                            id="span_id_adresse_politique_confidentialite">SuperCar/Privacy.com</span></p>
                    ...
                    <p>Toutefois, en cas de modification substantielle de cette politique, l'utilisateur en sera informé
                        de la manière suivante&nbsp;:</p>
                    <p style="padding-left: 30px;"><span id="span_id_modification_substantielle_moyen_information">Par
                            e-mail a l'adresse communiquée par<br />l'utilisateur.</span></p>

                    <p>Il est porté à la connaissance de l'utilisateur que la dernière mise à jour de la présente
                        politique de confidentialité est intervenue le&nbsp;: <span id="span_id_date_derniere_maj"
                            class="encours">21/03/2023</span>.</p>
                </td>
            </tr>
        </table>
